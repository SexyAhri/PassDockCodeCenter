...
export const uiCopy: Record<Locale, AppCopy> = {
  "zh-CN": {
    ...
    store: {
      ...
      noticeTitle: "下单流程",
      noticeLead:
        "先在主站完成注册，再在这里下单，最后回主站或 订单查询 领取结果。",
    ...
    checkout: {
      ...
      flowSteps: [
        ...
        {
          title: "执行履约",
          detail: "按订单号发码，并同步至站内与 Telegram。",
        },
      ],
      summaryLabels: {
        sku: "SKU",
  ...
  "en-US": {
    ...
    store: {
      ...
      bannerLead:
        "Storefront for recharge, subscription, and enterprise orders.",
    ...
    checkout: {
      ...
      flowSteps: [
        {
          title: "Create order",
          detail: "Freeze SKU price, payment, and delivery.",
        },
        { title: "Confirm payment", detail: "Confirm via QR or watcher." },
        {
          title: "Fulfill order",
          detail: "Issue codes and sync to web and Telegram.",
        },
      ],
      summaryLabels: {
        sku: "SKU",
    ...
    admin: {
      ...
      login: {
        ...
        subtitle:
          "Manage products, orders, payments, and fulfillment in one place.",
        ...
        features: [
          {
            title: "Product board",
            description:
              "Review SKUs, prices, stock, and payment configuration in one place.",
          },
          {
            title: "Order fulfillment",
            description:
              "Track payment state, code issuance, and delivery path together.",
          },
          {
            title: "Customer records",
            description:
              "Find accounts quickly by region, activity, and spend tier.",
          },
          {
            title: "Ops controls",
            description:
              "Centralize automation, review rules, and channel switches.",
          },
        ],
      },
      dashboard: {
        ...
        reminderBody:
          "Higher-ticket orders should pass manual review before automated delivery.",
      },
      products: {
        title: "Product management",
        subtitle:
          "Review live SKUs, inventory, billing cycles, and payment methods.",
      },
      orders: {
        title: "Order center",
      ...
      settings: {
        ...
        subtitle:
          "Manage payments, integrations, fulfillment, and runtime settings.",
        ...
        deliveryItems: [
          "Website code delivery",
          "Telegram sync delivery",
          "Failure retry queue",
        ],
        riskItems: [
          "Manual review for high-value orders",
          "Low stock alerting",
          "Auto-close on payment timeout",
        ],
      },
      status: {
        online: "Live",
