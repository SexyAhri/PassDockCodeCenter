-- PassDock PostgreSQL schema draft
-- Goal: generic digital fulfillment platform
-- Notes:
-- 0. This file is the scale-out relational schema variant.
-- 1. Recommended PostgreSQL version: 14+.
-- 2. JSON-like fields use JSONB.
-- 3. `updated_at` is expected to be maintained by application code.
...
CREATE TABLE IF NOT EXISTS integration_actions (
  ...
  header_template JSONB DEFAULT NULL,
  query_template JSONB DEFAULT NULL,
  body_template JSONB DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS fulfillment_strategies (
  ...
  delivery_template JSONB DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS delivery_strategies (
  ...
  strategy_name TEXT NOT NULL,
  channel_type TEXT NOT NULL,
  message_template JSONB DEFAULT NULL,
  mask_policy JSONB DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS products (
  ...
  display_price NUMERIC(18,8) NOT NULL DEFAULT 0,
  currency TEXT NOT NULL DEFAULT 'USD',
  enabled BOOLEAN NOT NULL DEFAULT TRUE,
  sort_order INTEGER NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS orders (
  ...
  product_snapshot JSONB DEFAULT NULL,
  payment_method TEXT NOT NULL,
  currency TEXT NOT NULL DEFAULT 'USD',
  price_amount NUMERIC(18,8) NOT NULL DEFAULT 0,
  pay_amount NUMERIC(18,8) DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS order_items (
  ...
  unit_amount NUMERIC(18,8) NOT NULL DEFAULT 0,
  line_amount NUMERIC(18,8) NOT NULL DEFAULT 0,
...
CREATE TABLE IF NOT EXISTS refund_records (
  id BIGSERIAL PRIMARY KEY,
  order_id BIGINT NOT NULL REFERENCES orders(id) ON DELETE CASCADE,
  payment_record_id BIGINT DEFAULT NULL REFERENCES payment_records(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS fulfillment_records (
  ...
  result_data_masked JSONB DEFAULT NULL,
  external_ref TEXT DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS code_issue_records (
  ...
  order_id BIGINT NOT NULL REFERENCES orders(id) ON DELETE CASCADE,
  order_no TEXT NOT NULL,
  fulfillment_record_id BIGINT DEFAULT NULL REFERENCES fulfillment_records(id) ON DELETE SET NULL,
  code_type TEXT NOT NULL,
  issue_status TEXT NOT NULL DEFAULT 'pending',
  provider_key TEXT DEFAULT NULL,
  action_key TEXT DEFAULT NULL,
  issued_code_encrypted TEXT DEFAULT NULL,
  issued_code_masked JSONB DEFAULT NULL,
...
CREATE TABLE IF NOT EXISTS delivery_records (
  ...
  delivered_content_masked JSONB DEFAULT NULL,
  error_message TEXT DEFAULT NULL,
  delivered_at TIMESTAMPTZ DEFAULT NULL,
  created_at TIMESTAMPTZ NOT NULL DEFAULT NOW(),
  updated_at TIMESTAMPTZ NOT NULL DEFAULT NOW()
...
CREATE TABLE IF NOT EXISTS support_tickets (
  ...
  user_id BIGINT DEFAULT NULL REFERENCES users(id) ON DELETE SET NULL,
  order_id BIGINT DEFAULT NULL REFERENCES orders(id) ON DELETE SET NULL,
...
CREATE TABLE IF NOT EXISTS admin_operation_logs (
  id BIGSERIAL PRIMARY KEY,
  admin_user_id BIGINT DEFAULT NULL REFERENCES users(id) ON DELETE SET NULL,
